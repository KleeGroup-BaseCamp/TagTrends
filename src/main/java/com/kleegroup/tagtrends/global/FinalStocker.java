...
public class FinalStocker {
	...
	private final int expireAfterSeconds = 3600 * 24; //24h
	...
	public FinalStocker(final DB db, final String collectionName) throws UnknownHostException {
		this.db = db;
	...
	public void printCollection() {
		...
		final DBCursor cursor = coll.find().limit(10);
	...
	public void remove(final String field, final String value) {
	...
	public void insertOne(final DBObject dbObject) {
